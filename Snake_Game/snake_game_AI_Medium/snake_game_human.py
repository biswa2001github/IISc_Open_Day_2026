...
class SnakeGame:
    ...
    def _place_food(self):
        # Loop until a valid food position is found (not on the snake or obstacles)
        while True:
    ...
    def show_game_over_screen(self):
        """Display a game over screen with Retry and Quit buttons. Return True for Retry, False for Quit."""
        self.display.fill(BLACK)
